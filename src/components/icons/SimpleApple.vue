<template>
  <svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg"
    ...
    xmlns:sodipodi="http://sodipodi.sourceforge.net/DTD/sodipodi-0.dtd" xmlns:ns1="http://sozi.baierouge.fr" id="svg2"
    viewBox="0 0 442.23 482.04" version="1.1">
    <defs id="defs4">
    ...
    <g id="layer1" transform="translate(-185.44 -156.02)">
      <g id="g5413" transform="translate(4.0406 -68.69)">
        ...
        <path id="path3070" d="m390.93 294.24c-60.97-42.23-91.1-45.32-135.36-48.48" stroke="#3bae28" stroke-width="1px"
          fill="none" />
      </g>
    </g>
  </svg>
